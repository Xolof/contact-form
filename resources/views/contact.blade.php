<x-myNiceLayout>
  ...
  <form class="mt-8 space-y-6" action="/add-message" method="POST" novalidate>
    ...
    <div>
      <button type="submit" class="justify-center w-full inline-flex items-center px-4 py-2 bg-gray-700 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-600 focus:bg-gray-700 active:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
        Send
      </button>
    </div>
  </form>
